...
import (
	...
	"github.com/hezro/kubernetes-vault/cmd/controller/client"
	"github.com/hezro/kubernetes-vault/cmd/controller/cluster"
	"github.com/hezro/kubernetes-vault/cmd/controller/metrics"
...
var RootCmd = &cobra.Command{
	...
	Long: `Kubernetes-vault is a Kubernetes controller that watches new pods for certain annotations
		...
		to a shared volume for the pod. More information at https://github.com/hezro/kubernetes-vault`,
